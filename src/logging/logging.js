...
const leadingZero = (value) => {
    return Number(value)<10?value="0"+value:value;
}
const logging = (req, res, next) => {
    ...
    const formatted_date =
        ...
        "-" +
        leadingZero((current_datetime.getMonth() + 1)) +
        "-" +
        leadingZero(current_datetime.getDate()) +
        " " +
        leadingZero(current_datetime.getHours()) +
        ":" +
        leadingZero(current_datetime.getMinutes()) +
        ":" +
        leadingZero(current_datetime.getSeconds());
